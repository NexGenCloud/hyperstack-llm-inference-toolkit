...
llm_binding.db   |   Creating database 'inference_db' and granting privileges to 'db_user'
llm_binding.db   | CREATE DATABASE
llm_binding.db   | GRANT
llm_binding.db   |   Creating database 'inference_test_db' and granting privileges to 'db_user'
llm_binding.db   | CREATE DATABASE
llm_binding.db   | GRANT
