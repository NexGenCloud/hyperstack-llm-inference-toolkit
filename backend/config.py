...
class TestConfig(Config):
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://db_user:db_password@db:3306/inference_test_db'
...
class IntegrationTestConfig(Config):
    SQLALCHEMY_DATABASE_URI = 'postgresql://db_user:db_password@db:5432/inference_test_db'
    LLM_ENDPOINTS_CONFIG = make_test_llm_config()
    MOCK_LLM = False
    REDIS_DB = 1
